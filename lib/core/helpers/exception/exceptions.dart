...
class SavingLocalDataException extends AppException {
  const SavingLocalDataException({required String details, data})
      : super("Exception While Saving Data To Local", details, data);
}
class FetchingLogsLocalDataException extends AppException {
  const FetchingLogsLocalDataException({required String details, data})
      : super("Exception While Fetching Logs From Local", details, data);
}
  ...
  Failure.fromDioError(DioError dioError) {
    switch (dioError.type) {
      ...
      case DioErrorType.other:
        print("DioErrorType.other : ${dioError.message}");
        print("DioErrorType.other : ${dioError.error}");
        print("DioErrorType.other : ${dioError.stackTrace}");
